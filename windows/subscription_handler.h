...
class SubscriptionHandler
{
  public:
    ...
    std::string CreateSubscription(const std::wstring &channel, const std::wstring &query,
  ...
  private:
    ...
    static DWORD WINAPI SubscriptionCallback(EVT_SUBSCRIBE_NOTIFY_ACTION action, PVOID user_context,
